...
class WGT_INTERIOR1
{
	idd = -1;
	movingenable = true;
	onLoad = "_this ExecVM 'scripts\interior\items.sqf'";
	...
	class Controls
	{
		...
		class dialogChoose1: RscShortcutButton
		{
			...
			action= "[] call fnc_Pos_fired1;_nil=[]ExecVM ""scripts\interior\spawn.sqf"";closeDialog 0;";
		};
		...
		{
			idc = -1;
			text = "scripts\interior\emerald.paa";
...
class WGT_INTERIOR2
{
	...
	class Controls
	{
		...
		class dialogChoose2: RscShortcutButton
		{
			...
			w = 0.0594089 * safezoneW;
			h = 0.0500295 * safezoneH;
			action= "[] call fnc_Pos_fired2;_nil=[]ExecVM ""scripts\interior\spawn.sqf"";closeDialog 0;";
		};
...
class WGT_INTERIOR3
{
	...
	class Controls
	{
		...
		class dialogChoose3: RscShortcutButton
		{
			...
			w = 0.0594089 * safezoneW;
			h = 0.0500295 * safezoneH;
			action= "[] call fnc_Pos_fired3;_nil=[]ExecVM ""scripts\interior\spawn.sqf"";closeDialog 0;";
		};
...
class WGT_INTERIOR4
{
	...
	class Controls
	{
		...
		class dialogChoose4: RscShortcutButton
		{
			...
			w = 0.0594089 * safezoneW;
			h = 0.0500295 * safezoneH;
			action= "[] call fnc_Pos_fired4;_nil=[]ExecVM ""scripts\interior\spawn.sqf"";closeDialog 0;";
		};
...
class WGT_INTERIOR5
{
	...
	class Controls
	{
		...
		class dialogChoose5: RscShortcutButton
		{
			...
			w = 0.0594089 * safezoneW;
			h = 0.0500295 * safezoneH;
			action= "[] call fnc_Pos_fired5;_nil=[]ExecVM ""scripts\interior\spawn.sqf"";closeDialog 0;";
		};
...
class WGT_INTERIOR6
{
	...
	class Controls
	{
		...
		class dialogChoose6: RscShortcutButton
		{
			...
			w = 0.0594089 * safezoneW;
			h = 0.0500295 * safezoneH;
			action= "[] call fnc_Pos_fired6;_nil=[]ExecVM ""scripts\interior\spawn.sqf"";closeDialog 0;";
		};
...
class WGT_INTERIOR7
{
	...
	class Controls
	{
		...
		class dialogChoose7: RscShortcutButton
		{
			...
			w = 0.0594089 * safezoneW;
			h = 0.0500295 * safezoneH;
			action= "[] call fnc_Pos_fired7;_nil=[]ExecVM ""scripts\interior\spawn.sqf"";closeDialog 0;";
		};
...
class WGT_INTERIOR8
{
	...
	class Controls
	{
		...
		class dialogChoose8: RscShortcutButton
		{
			...
			w = 0.0594089 * safezoneW;
			h = 0.0500295 * safezoneH;
			action= "[] call fnc_Pos_fired8;_nil=[]ExecVM ""scripts\interior\spawn.sqf"";closeDialog 0;";
		};

...
_numbeofBombs = 10;                       			//how many bombs are dropped assuming 1 per cycle
...
case 47: {["Vyshnoye",1.5,6590.3159,6029.1128]};
...
//Random Heli-Type
if (_rmodyn) then {
	_heliModel = ["Su25_TK_EP1","A10","MV22"] call BIS_fnc_selectRandom;
